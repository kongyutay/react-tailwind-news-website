...
const SinglePage = () => {
    ...
    return (
        <>
            <div className="w-1/2 m-auto p-2 w-fullscreen768">
                {!sliderOpen ? (
                    <div className="mt-16">
                            ...
                            <div key={index}>
                                <div className="grid place-items-center">
                                    ...
                                    <div className="text-center">
                                        <h4 className="font-bold text-xl text-gray-500">{val.name}</h4>
                                        <p className="text-gray-500">{val.designation}</p>
                                    </div>
                                </div>

                                <h2 className="text-4xl font-bold my-6 text-center">{val.title}</h2>
                                ...
                                <div>
                                    ...
                                    Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed molestie ipsum non commodo dapibus. Aliquam ac dui tellus. Phasellus a sollicitudin magna, hendrerit viverra lorem. Quisque auctor facilisis est quis congue. Nulla commodo tincidunt augue vitae molestie. Suspendisse suscipit egestas libero, quis rhoncus tellus. Sed ullamcorper erat sit amet risus scelerisque, at placerat arcu egestas.
                                    </p>
                                </div>
                            </div>
                        ))}
                        <div className="grid grid-cols-3 gap-1 mt-4">
                            {gridItems.map((val, index) => (
                                <div key={index} onClick={() => openImg(index)} className="cursor-pointer">
                                    <img src={val.trending_img} alt="img" className="rounded-lg"/>
                                </div>
                            ))}
                        </div>
